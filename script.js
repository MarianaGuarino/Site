document.addEventListener("DOMContentLoaded", function() {
    ...
    var startDate = new Date("2023-01-25"); // Coloque a data que começaram a namorar aqui
    ...
    var messages = [
        ...
        "Porque você é meu parceiro de vida e aventuras.",
